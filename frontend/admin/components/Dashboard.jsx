...
const Dashboard = () => {
  ...
  const enrollmentData = [
    { level: 'Nursery', students: 45 },
    { level: 'Pre-K', students: 52 },
  ...
  const todaySchedule = [
    { time: '8:00 AM', class: 'Nursery A - Math Fundamentals', teacher: 'Mrs. Johnson' },
    { time: '9:30 AM', class: 'Pre-K B - Creative Arts', teacher: 'Mr. Santos' },
    { time: '11:00 AM', class: 'Kindergarten - Science Fun', teacher: 'Ms. Garcia' },
    { time: '1:00 PM', class: 'Pre-K A - Music & Movement', teacher: 'Mrs. Lee' }
  ];
